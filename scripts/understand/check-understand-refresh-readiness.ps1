...
$publicScriptRoot = Split-Path -Path $scriptRoot -Parent
$repoRoot = Split-Path -Path $publicScriptRoot -Parent
$wrapperPath = Join-Path $publicScriptRoot 'refresh-understand-graph.ps1'
