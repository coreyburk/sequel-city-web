...
4. Draft:
   ...
   - one work package traceability line generated by the helper from the resolved work package path: `WP: WP-###`
...
- Traceability line: `WP: WP-###`, first body line after the title
