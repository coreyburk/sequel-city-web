...
- Do not describe authentication, authorization, cloud deployment, suspect verification, case progression, notebook persistence, or runtime AI behavior as implemented API features.
